...
from src.app.service.bank import BankService
...
from src.app.service.journal import *
...
#     is_business=True,
# )
# print(BankService.create_acct_from_bank_acct(bank_acct))
print(AcctService.get_account(acct_id = SystemAcctNumber.OUTPUT_TAX))
print("FX_CAD: ", FxService.get(CurType.CAD, date(2024, 10, 20)))
print("FX_USD: ", FxService.convert(100, CurType.USD, date(2024, 11, 6)))